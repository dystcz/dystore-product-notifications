...
spl_autoload_register(function ($class) {
    $deprecationMap = [
        'Dystcz\\LunarApiProductNotification' => 'Dystore\\ProductNotifications',
        'Dystcz\\LunarApiProductNotification\\LunarApiProductNotificationServiceProvider' => 'Dystore\\ProductNotifications\\ProductNotificationsServiceProvider',
    ];
